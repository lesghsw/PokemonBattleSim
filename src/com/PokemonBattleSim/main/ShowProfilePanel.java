...
public class ShowProfilePanel extends JPanel {
    ...
    public ShowProfilePanel(Window window) {
        ...
        scrollPane = new JScrollPane(profilesContainer, 
        ...
        for (String profileName : profileNames) {
            ...
            deleteButton.addActionListener(e -> {
                int confirm = JOptionPane.showConfirmDialog(
                        this,
                        "Sei sicuro di voler eliminare il profilo '" + profileName + "'?",
                        "Conferma Eliminazione",
                        JOptionPane.YES_NO_OPTION);
                if (confirm == JOptionPane.YES_OPTION) {
                    boolean success = SaveManager.deleteProfile(profileName);
                    if (success) {
                        JOptionPane.showMessageDialog(this, "Profilo eliminato con successo!", "Eliminazione", JOptionPane.INFORMATION_MESSAGE);
                        // Ricarica il pannello per rimuovere il profilo eliminato
                        refreshPanel();
                    } else {
                        JOptionPane.showMessageDialog(this, "Errore durante l'eliminazione del profilo!", "Errore", JOptionPane.ERROR_MESSAGE);
                    }
                }
            });
            ...
            profilesContainer.add(Box.createVerticalStrut(20));
